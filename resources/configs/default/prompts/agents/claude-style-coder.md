...
IMPORTANT: If the current context does not specify the programming language or structure of the project, ALWAYS detect them with the available tools, never make assumptions.
