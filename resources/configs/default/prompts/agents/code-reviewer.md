...
2. Use `grep_search` to find related code, similar patterns, or potential duplications
3. Identify the purpose and requirements of the code
4. Understand the broader codebase patterns and conventions
