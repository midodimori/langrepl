...
class TestTokenCostMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_extracts_token_usage_from_ai_message(self):
    ...
    @pytest.mark.asyncio
    async def test_no_cost_calculation_when_pricing_not_available(self):
    ...
    @pytest.mark.asyncio
    async def test_handles_partial_pricing_info(self):
