...
"""
        ...
        skill = Skill.from_file(skill_path, "test-category")
    ...
    def test_from_file_no_frontmatter(self, temp_dir):
    ...
    def test_from_file_no_name(self, temp_dir):
    ...
    def test_from_file_minimal(self, temp_dir):
...
class TestSkillFactory:
    ...
    def test_load_skills_empty_dir(self, temp_dir):
        """Test that load_skills returns empty dict for empty directory."""
        factory = SkillFactory()

        skills = factory.load_skills(temp_dir)

        assert skills == {}

    def test_load_skills_missing_dir(self, temp_dir):
        """Test that load_skills returns empty dict for missing directory."""
        factory = SkillFactory()

        skills = factory.load_skills(temp_dir / "missing")

        assert skills == {}

    def test_load_skills_single_skill(self, temp_dir):
    ...
    def test_load_skills_multiple_categories(self, temp_dir):
    ...
    def test_load_skills_skips_files_in_category_dir(self, temp_dir):
    ...
    def test_load_skills_skips_missing_skill_md(self, temp_dir):
    ...
    def test_load_skills_skips_invalid_skill(self, temp_dir):
    ...
    def test_get_module_map(self, temp_dir):
    ...
    def test_get_all_skills(self, temp_dir):
    ...
    def test_get_skill_not_found(self, temp_dir):
